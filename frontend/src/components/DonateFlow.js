  ...
  if ((!nextToPaymentPressed || donateAmount == 0)) {
        ...
        <div className="row justify-content-center" style={{ marginRight: "5%", marginLeft: "10%" }} id="payment">
          ...
          {(donateAmount == 0) ? (
            <div className="col-xl-5 col-lg-5 col-sm-12">
              <h1 style={headerBase}>Your donation is giving
                  <mark style={numOfMealsNumber}>
                    {props.recipientFirstName} {props.recipientLastName}
                  </mark>
                  a meal.
              </h1>
              ...
              <div className='col-xl-5 col-lg-5 col-sm-12'>
                <h1 style={bigText}>You're donating  around
                  <mark style={numOfMealsNumber}>
                    {donateAmount / 12.5}
                  </mark>
                  meals to
    ...
    return (
      <ConfirmationPage
        ...
        exp={exp} cvc={cvc}
        amount={donateAmount}
        handleBackToPaymentInfo={() => handleBackFromConfirmation()}
