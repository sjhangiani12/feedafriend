      ...
      <div style={root}>
        ...
        <div className="container-fluid">
          <div className="row flex-wrap" style={header}>
            <h1 style={{ fontSize: "3em", margin: "0px" }}>Hi! I'm {props.data.first_name} {props.data.last_name}</h1>
            <div className="row mt-2">
              <div className="col-md-6 col-sm-12" style={{ justifyContent: "center" }} >
                {/* <p style={{ color: "#828282", fontFamily: "sans-serif", fontWeight: "bold" }}>WHAT WE DO</p> */}
                <img src={"data:*/*;base64," + props.data.prof_pic} style={{
                  width: "100%",
                  borderRadius: "6px"
                }} />

                <div className="row mx-1 my-1">
                  {props.data.social_media_links[0] != null ?
                    <a href={props.data.social_media_links[0]}>
                  ...
                  {props.data.social_media_links[1] != null ?
                    <a href={props.data.social_media_links[1]}>
                      <svg className="mx-1" width="10%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  {props.data.social_media_links[2] != null ?
                    <a href={props.data.social_media_links[2]}>
                      <svg className="mx-1" width="10%" height="100%" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
