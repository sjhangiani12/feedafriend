...
function Profile(props) {
  ...
  const [uploadsLoaded, setUploadsLoaded] = useState(defaults);

  const {a,b,c} = uploadsLoaded
              ...
              {props.prof_pic != "" ? (<> 
                ...
                <div className="row mt-2">
                  <div className="col-md-4 col-sm-12" style={{ justifyContent: "center" }} >
                    {!profLoaded && (<BounceLoader color={"#999999"} size={50} />) }
                    <img onLoad={() => setProfLoaded(true)} src={"data:*/*;base64," + props.prof_pic} style={{
                      width: "100%",
                      borderRadius: "6px"
                    }} />
                ...
                <div style={uploadsContainer} >
                  {props.uploads != null &&
                    props.uploads.map(function (file, index) {
                      return (
                        <>
                          {!uploadsLoaded[index] && (<BounceLoader color={"#999999"} size={50} />)}
                          <div key={index} style={{ marginRight: "3%" }} onClick={() => {
                            setImageToPreview("data:*/*;base64," + file[1]);
                            setCaptionToPreview(file[0]);
                            setShowModal(true);
                          }}>
                            <img onLoad={() => setUploadsLoaded(prevState => ({
                              ...prevState,
                              [index]: true
                            }))} style={upload} src={"data:*/*;base64," + file[1]} />
                          </div>
                        </>
                      )
                    })
