            ...
            <div className="col-md-4 col-sm-12" style={{ justifyContent: "center" }} >
              ...
              <div className="row mx-1 my-1">
                {props.social_media_links[0] != "" ?
                    <svg className="mr-1" width="5vw" height="auto" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                {props.social_media_links[2] != "" ?
                  <svg className="mr-1" width="5vw" height="auto" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
