            ...
            <div className="row mt-2">
              <div className="col-md-6 col-sm-12" style={{ justifyContent: "center" }} >
                ...
                <div className="row mx-1 my-1">
                  {props.social_media_links[0] != null ?
                    <a href={props.social_media_links[0]}>
                  ...
                  {props.social_media_links[1] != null ?
                    <a href={props.social_media_links[1]}>
                      <svg className="mx-1" width="10%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  {props.social_media_links[2] != null ?
                    <a href={props.social_media_links[2]}>
