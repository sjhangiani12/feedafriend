    ...
    <div className="container-fluid" style={who}>
      <div className="row" style={ro} >
        <div className="col-xl-5 col-md-4 col-sm-12 mx-4 mt-3">
            ...
            <p align="left ">We are a group of five engineers and develoeprs from the Seattle area who love to eat. While complaining over Zoom about how we couldn't grab dinner together, we came up with the idea to bring meals to the people who need it most - Feed a Friend was born! </p>

        </div>
        <div className="col-xl-5 col-md-4 col-sm-12 mx-4 mt-3">
          <h2 align = "left">How does this work?</h2>
            <p align="left">Anyone can create a Feed a Friend profile. They simply tell their story, and we leave it up to donors to decide who receives their money! 100% of donated funds becomes credits for a meal delivery service like DoorDash.</p>
